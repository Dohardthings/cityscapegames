...
export default Ember.Controller.extend({
  ...
  actions: {
    ...
    check: function(){
      var value = document.getElementById('input11').value;
      var check = /(red)|(maroon)|(Red)|(Maroon)/g.test(value);
      //check will be true or false
      if (check){
      console.log("woohoo!");
      this.transitionToRoute('knights-of-infernal-order.adventure.chapter4-5');
      }
      if (!check){
        console.log("fuuuuck!");
